...
<body>
    <header>
        ...
        <div class="nav">
            <a href="logout.php" class="subnav"><i class="fas fa-sign-out-alt"></i>Logout</a>
            <a href="#" class="subnav" ><i class="fas fa-user-shield"></i>Admin</a>
        </div>
        </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            <h1 style="font-size: 32px;" ><i class="fas fa-database"></i>File Manger</h1>
